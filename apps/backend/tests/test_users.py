...
class TestAdminUserManagement:
    ...
    def test_non_admin_cannot_update_other_users(self, test_client, test_db, auth_token):
    ...
    def test_admin_update_user_with_missing_fields(self, test_client, test_db, admin_token):
    ...
    def test_admin_update_user_with_duplicate_email(self, test_client, test_db, admin_token):
